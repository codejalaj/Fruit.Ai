  ...
  const [faqs, setFaqs] = useState([
    {
      ...
      title: "why we need to eat apple everyday",
      description:
        ": Apples are packed with essential nutrients like fiber, vitamins (especially vitamin C), minerals, and antioxidants this nutrients support our body and maintain our body",
      fruitName: "Apple",
    },
    {
      id: 2,
